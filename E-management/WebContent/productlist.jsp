...
<body>
<form action="Pro_addServlet" method="get">

  <table width="700px" >
					<tr >
						<td width="185px"  height="40px" style=" background-color: #F5F5F5;">商品名称</td>
						<td style="background-color:#FFFFFF"><input  id="pname" name="pname"/></td>
					...
					<tr >
						...
						<td style="background-color: #FFFFFF"><input name="pno" /></td>
					...
					<tr >
						...
						<td style="background-color:#FFFFFF"><input type="file" value="选择文件" name="pic"></input></td>
						</tr>
						<tr >
						<td width="185px"  height="40px"style=" background-color: #F5F5F5;">商品价格</td>
						<td style="background-color: #FFFFFF"><input  name="price"/></td>
					</tr>
					<tr >
					...
					<tr >
						...
						<td style="background-color:#FFFFFF"><textarea id="edit" name="edit" ></textarea>
						</td>
					</tr>
				</table>
