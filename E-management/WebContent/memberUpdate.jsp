...
<html>
   ...
   <style type="text/css">
	...
	<body>
		<form action="SifUpdateServlet" method="post">
		<input type="hidden" id="id" name="id" value="${cc.id }"/>
			<table width="700px">
				<tr>
					<td width="185px"  height="40px" style=" background-color: #F5F5F5;">买家账号</td>
						<td style="background-color:#FFFFFF"><input  id="aid" name="aid" value="${cc.aid }"/></td>
				</tr>
				<tr>
					<td width="185px"  height="40px" style=" background-color: #F5F5F5;">买家昵称</td>
						<td style="background-color:#FFFFFF"><input  id="nickname" name="nickname" value="${cc.nickname }"/></td>
				</tr>
				<tr>
					<td width="185px"  height="40px" style=" background-color: #F5F5F5;">订单金额</td>
						<td style="background-color:#FFFFFF"><input  id="money" name="money" value="${cc.money }"/></td>
				</tr>
				<!--<tr>
